...
A_TrayMenu.Add("Epic Login Watcher", NYUToggleWatcher.Bind("epic"))
A_TrayMenu.Add("PowerScribe Login Watcher", NYUToggleWatcher.Bind("ps360"))
A_TrayMenu.Add("Visage Login Watcher", NYUToggleWatcher.Bind("visage"))
